class OneEmergencyModel {
  bool? success;
  Data? data;

  OneEmergencyModel({this.success, this.data});

  OneEmergencyModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.emergency, this.report, this.payment});
...
class Emergency {
  ...
  Emergency.fromJson(Map<String, dynamic> json) {
    ...
    if (json['img'] != null) {
      img = json['img'].contains('https') ? json['img'] : 'https://rak.bytes-sa.com/uploads/projects/cover/${json['img']}';
    }
...
class Report {
  ...
  Report.fromJson(Map<String, dynamic> json) {
    ...
    engineer = json['engineer'] != null ? Technical.fromJson(json['engineer']) : null;
  }
...
class Technical {
  ...
  Technical.fromJson(Map<String, dynamic> json) {
    ...
    if (json['avatar'] != null) {
      avatar = json['avatar'].contains('https') ? json['avatar'] : 'https://rak.bytes-sa.com/uploads/projects/cover/${json['avatar']}';
    }
    dob = json['dob'];
    gender = json['gender'];
    phone = json['phone'];
