      ...
      builder: (context, state) => Column(
        ...
        children: [
          ...
          Container(
            ...
            child: InkWell(
              onTap: () =>
                  MainBlocMaintenanceCubit.of(context).selectMoreImages(),
              child: Row(
                  ...
                  builder: (context, state) {
                    return SizedBox(
                      ...
                      child: ListView.separated(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: FileImage(
                                    MainBlocMaintenanceCubit.of(context)
                                        .imagesAttachment[index],
                                  ),
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ...
                            Container(
                              ...
                              child: Center(
                                child: InkWell(
                                  onTap: () =>
                                      MainBlocMaintenanceCubit.of(context)
                                          .imagesAttachmentClear(index: index),
                                  child: Container(
                        ...
                        itemCount: MainBlocMaintenanceCubit.of(context)
                            .imagesAttachment
                            .length,
                      ),
                    );
