...
class CustomDropDownMenuProgress extends StatefulWidget {
  final String? selectedItem;
  final List<String> items;
  final double? width;

  const CustomDropDownMenuProgress({
    super.key,
  ...
  @override
  State<CustomDropDownMenuProgress> createState() => _CustomDropDownMenuProgressState();
}

class _CustomDropDownMenuProgressState extends State<CustomDropDownMenuProgress> {
  String newSelected = '';
    ...
    return Container(
      ...
      child: DropdownButton<String>(
        ...
        onChanged: (String? newValue) {
          ...
          ProgressCubit.of(context).addSelected(newSelected: newValue);
          setState(() {});
        },
        isExpanded: true,
