                  ...
                  () => Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ItemTadaDetailsWidget(
                          nameTada: '${'Title'.tr}:-',
                          detailsTada: model.tada.value.title,
                        ),
                        const SizedBox(
                          height: 10,
                        ),
                        ItemTadaDetailsWidget(
                          nameTada: '${'Description'.tr}:-',
                          detailsTada: parse(model.tada.value.description ?? '').body!.text,
                        ),
                        const SizedBox(
                          height: 20,
                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: ' ( ${model.tada.value.attachments!.length} )',
                                      style: const TextStyle(
                                        color: Colors.black, // Change this to the desired style for the bracketed value
                                        fontSize: 16, // Change this to the desired style for the bracketed value
                                        fontWeight: FontWeight.bold, // Change this to the desired style for the bracketed value
                                      ),
                                    ),
                                  ],
                                ),
                        ...
                        ItemTadaDetailsWidget(
                          nameTada: '${'Verifiedby'.tr}:-',
                          detailsTada: parse(model.tada.value.verifiedBy ?? 'N/A').body!.text,
                        ),
                      ],
                    ),
                  ),
...
class ItemTadaDetailsWidget extends StatelessWidget {
  final String nameTada;
  final String detailsTada;
  const ItemTadaDetailsWidget({
    super.key,
    required this.nameTada,
    required this.detailsTada,
  });
