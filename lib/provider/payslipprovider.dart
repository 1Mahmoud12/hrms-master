...
class PaySlipProvider with ChangeNotifier {
  final List<PaySlip> _paySlipList = [
    PaySlip(
  ...
  final List<PaySlipAttribute> _earningList = [
  ...
  double getTotalEarning(){
    ...
    for(final item in _earningList){
      value += item.value;
    }
  ...
  final List<PaySlipAttribute> _deductionList = [
  ...
  double getTotalDeduction(){
    ...
    for(final item in _deductionList){
      value += item.value;
    }
